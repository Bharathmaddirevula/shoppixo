              ...
              <div key={item.productId} style={styles.row}>
                ...
                <div style={styles.info}>
                  ...
                  <div style={styles.qtyRow}>
                    <button style={styles.qtyBtn} onClick={() => decreaseQty(item.productId)}>-</button>
                    <span style={styles.qty}>{item.quantity}</span>
                    <button style={styles.qtyBtn} onClick={() => increaseQty(item.productId)}>+</button>
                  </div>
...
const styles = {
  container: { background: "#fff", padding: "16px", borderRadius: "12px", boxShadow: "0 4px 12px rgba(0,0,0,0.08)" },
  ...
  qtyBtn: { padding: "4px 8px", borderRadius: "6px", border: "1px solid #ccc", cursor: "pointer" },
  qty: { minWidth: "24px", textAlign: "center" },
  removeBtn: { marginTop: "8px", background: "#ff4d4f", color: "#fff", padding: "6px 10px", border: "none", borderRadius: "6px", cursor: "pointer" },
  total: { marginTop: "18px", fontWeight: "bold", textAlign: "right" },
};
